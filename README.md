...
If the conditions are met, the GitHub Actions of the [msword-properties-generator](https://github.com/johantre/msword-properties-generator) repo are triggered that generates the necessary document pair. 
